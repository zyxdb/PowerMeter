...
/* 当使用 NI-VISA 扩展时，你必须链接到带有 NI-VISA的VISA 库                  */
/* 目前，NI-VISA提供的扩展有：                                               */
/*                                                                           */
...
/* PXI (Compact PCI eXtensions for Instrumentation) 和 PCI 支持。            */
/* 使用这个，你必须在包含这个头文件之前定义宏 NIVISA_PXI。                   */
/* 您还必须使用 VISA 驱动程序开发向导创建一个 INF 文件。                     */
/*                                                                           */
...
/* viPeekXX/viPokeXX 的一组快速宏保证与 VISA 的其他实现的二进制兼容性        */
/* 要使用它，您必须在包含此标头之前定义宏 NIVISA_PEEKPOKE。                  */
/*                                                                           */
...
/* 支持不符合特定类的 USB 设备。                                             */
/* 使用这个，你必须在包含这个头文件之前定义宏 NIVISA_USB。                   */
/* 您还必须使用 VISA 驱动程序开发向导创建一个 INF 文件。                     */
/*---------------------------------------------------------------------------*/
